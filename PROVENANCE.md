...
This repository is the source of record for **CoreMap**, one of the nine tools in
...
|---|---|
| Tool | CoreMap |
| Canonical deployment | https://coremap.hallatec.com/ |
| Source of record | https://github.com/hallatec/hallatec-coremap |
...
A genuine deployment returns `repository: "https://github.com/hallatec/hallatec-coremap"` and
`canonical: "https://coremap.hallatec.com/"`. `Object.freeze` means a fork cannot quietly mutate
...
**4. Bidirectional link.** This repository names `https://coremap.hallatec.com/` as its canonical
deployment, and that deployment names `https://github.com/hallatec/hallatec-coremap` as its source. Either direction
...
curl -s https://coremap.hallatec.com/ | grep -A2 'code-repository'

# 2. The runtime object agrees (browser console)
#    HTC.provenance.repository === "https://github.com/hallatec/hallatec-coremap"

# 3. The canonical link points back at the tool's own subdomain
curl -s https://coremap.hallatec.com/ | grep 'rel="canonical"'
```
