...
Network segmentation coverage mapping

**Live:** [coremap.hallatec.com](https://coremap.hallatec.com/) · **Suite:** [Hallatec Forge](https://forge.hallatec.com/)
...
```bash
wrangler pages deploy . --project-name hallatec-coremap --branch=main
```
...
to this repository and to coremap.hallatec.com. See [PROVENANCE.md](PROVENANCE.md) for how to
